...
* Bob is using a password to generate a 128-bit encryption key. Explain why the key space is unlikely to be 2<pre>128</pre>, and why key entropy could be used to measure the equivalent key size. [Ref: Symmetric Key]
